...
/*
one-way data binding from the model(usestate) to the ui(react component) due to the value={addrress} property
one-way data binding from the ui(react component) to the model(usestate) due to the onChange={handleformdata} property
two-way data binding combination of both
*/
  ...
  return (
    <div className="p-4">
      ...
      <form onSubmit={savePlace}>
        ...
        <button type='submit' className="mx-auto my-4 flex rounded-full bg-primary py-3 px-20 text-xl font-semibold text-white">
          Save
        </button>
      </form>
    </div>
