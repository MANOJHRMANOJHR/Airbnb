import { differenceInDays } from 'date-fns'; // popular javascript library for working with dates
...
const BookingWidget = ({ place}) => {
  ...
  /* If either dateRange.from or dateRange.to is null (or falsy), then the condition will be false.*/
