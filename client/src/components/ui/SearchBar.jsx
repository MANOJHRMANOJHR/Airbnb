    ...
    <>
      <div className="flex w-4/6 overflow-hidden rounded-full border border-gray-400 bg-gray-300 shadow-sm hover:shadow-lg md:w-1/2">
        ...
        <div className="bg-blue flex cursor-pointer  items-center bg-primary text-white">
         ...
         //Yes — when you click the button, the onClick event will automatically pass the click event object (MouseEvent) as the parameter e to handleSearch.
         //But here the change is the button, not the targeted value , do e.target.value will be wrong in using
         >
            <svg
